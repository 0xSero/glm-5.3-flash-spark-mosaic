...
src='/home/valentine/glm53-full-observations-20260907/models/q3-smoke'
...
receipt=r/'source-q3-transfer.json';assert not receipt.exists()
...
with (r/'source-q3-transfer.log').open('w') as log:
