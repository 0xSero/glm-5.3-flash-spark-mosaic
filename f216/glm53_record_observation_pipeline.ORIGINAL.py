"""Local-only original-record observations, distinct from the fixed 24K suite.
...
def run(args):
    ...
    try:
        ...
        committed = state[0]
        phases = phase_plan(shards, committed, args.smoke_records, args.qualify_then_collect)
