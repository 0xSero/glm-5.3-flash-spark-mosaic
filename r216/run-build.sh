#!/bin/bash
set -x
W=/home/valentine/r216; SRC=/home/valentine/models/turboderp-glm53-flash-exl3-3p05bpw; DST=/home/valentine/models/glm53-3p05-pruned-r216
cd $W
echo "### pack $(date -u +%FT%TZ)"
python3 $W/prune_u216.py --src $SRC --dst $DST --plan $W/r216-plan.json --workers 5 2>&1 | tee $W/pack.log; echo "pack exit=${PIPESTATUS[0]}"
