...
r=Path('/release/results')/('k2-massmax-k256' if candidate else 'original-q3-control');q=Path('/queue')
pin='7c7a2e47c7cde8996ac54c6f2ca5c3f7532b682d5d7296408c97a14e8950f73c' if candidate else '05e0ff9cc6a3f87fbd8e27b46bb679e114579dfea3bc4afcc2d724b58be3d1ee'
def sha(p):
 h=hashlib.sha256()
 with p.open('rb') as f:
...
assert report['experts_per_layer']==(256 if candidate else 288)
...
receipt={'state':'CANDIDATE_K2_K256_RESULTS_SEALED' if candidate else 'ORIGINAL_Q3_RESULTS_SEALED','report_sha256':sha(r/'quality-report.json'),
