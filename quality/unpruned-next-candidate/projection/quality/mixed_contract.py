"""Fail-closed validation of the exact assembled projection6 candidate."""
import hashlib,json,re,struct
from pathlib import Path
MANIFEST_SHA='590ec08e84a66767e03964f7482e84c952e6b98c26cddc7d45983592c4e491f5'
...
def expected_bits(prefix):
 ...
 return 3 if layer in (5,26,31,32,35,36) and m[3]=='down_proj' else 2
...
def validate_candidate(root,experts):
 ...
 require(sha(mp)==MANIFEST_SHA,'not sealed projection6 manifest')
 ...
 require(m['layer_projection_bits']=={str(l):{'down_proj':3} for l in (5,26,31,32,35,36)} and m['default_bits']==2,'incorrect precision map')
