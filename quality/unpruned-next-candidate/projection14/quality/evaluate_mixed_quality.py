#!/usr/bin/env python3
"""Full-trunk mixed projection K2/K3 quality using the unchanged low-bpw BF16 head comparison.
...
def main():
    ...
    if args.source_inventory:
        ...
        artifact_mode = 'mixed_projection_k2_gateup_k3_down_candidate'
    ...
    identity = {'schema': 'glm53-mixed-full-trunk-quality-identity-v1',
                ...
                'layer_projection_bits': {str(l): {'down_proj': 3} for l in (5,6,7,20,22,23,26,27,28,31,32,35,36,37)}, 'default_bits': 2,
