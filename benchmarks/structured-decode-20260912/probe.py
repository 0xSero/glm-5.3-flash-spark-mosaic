...
TASK = '\nReturn one JSON object with key numbers containing every integer from 1 through 200, in ascending order. Finish immediately after 200.\n'
...
def cell(target, repeat):
    ...
    try:
        ...
        correct = parsed == {'numbers': list(range(1, 201))} and all(type(x) is int for x in parsed['numbers'])
