...
def main():
    ...
    if cfg.get("n_routed_experts") != 288: problems.append("n_routed_experts changed")
    receipt = {"schema": "dynamic-container-g2-v1", "point_id": "A2d", "plan_sha256": plan["plan_sha256"], "pass": not problems,
