...
def main():
    ...
    tc["dynamic_container"] = {"point_id": "A2d", "plan_sha256": plan["plan_sha256"], "status": "derived", "packer_version": PACKER_VERSION}
    ...
    manifest = {
        "schema": "dynamic-container-manifest-v1", "point_id": "A2d", "packer_version": PACKER_VERSION,
        ...
        "other_files": copied, "config_patch_keys": ["text_config.routed_experts_per_layer", "text_config.retained_expert_ids_by_layer", "text_config.dynamic_container"],
